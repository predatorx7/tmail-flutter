...
void main() {
  group('SanitizeAutolinkFilter test', () {
    ...
    test(
        ...
        () {
      final htmlValidate =
          sanitizeAutolinkFilter.process('See https://linagora.com at Hanoi');
      expect(
          htmlValidate,
          equals(
              'See <a href="https://linagora.com" target="_blank" rel="noreferrer">linagora.com</a> at Hanoi'));
    });
    ...
    test(
        ...
        () {
      final htmlValidate =
          sanitizeAutolinkFilter.process('See http://linagora.com at Hanoi');
      expect(
          htmlValidate,
          equals(
              'See <a href="http://linagora.com" target="_blank" rel="noreferrer">linagora.com</a> at Hanoi'));
    });
    ...
    test(
        ...
        () {
      final htmlValidate =
          sanitizeAutolinkFilter.process('See www.linagora.com at Hanoi');
      expect(
          htmlValidate,
          equals(
              'See <a href="https://www.linagora.com" target="_blank" rel="noreferrer">linagora.com</a> at Hanoi'));
    });
    ...
    test(
        ...
        () {
      final htmlValidate =
          sanitizeAutolinkFilter.process('See tdvu@linagora.com at Hanoi');
      expect(
          htmlValidate,
          equals(
              'See <a href="mailto:tdvu@linagora.com">tdvu@linagora.com</a> at Hanoi'));
    });
  });
}
