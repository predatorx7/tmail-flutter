  ...
  Path getClip(Size size) {
    ...
    if (isRight) {
      path.addRRect(RRect.fromLTRBR(
          0, 0, size.width - arrowSize, size.height, Radius.circular(radius)));
      ...
      path.addPath(path2,
          Offset(size.width - arrowSize, size.height - offset - 2 * arrowSize));
    } else {
      path.addRRect(RRect.fromLTRBR(
          arrowSize, 0, size.width, size.height, Radius.circular(radius)));
      ...
      path.addPath(
          path2, Offset(arrowSize, size.height - offset - 2 * arrowSize));
    }
