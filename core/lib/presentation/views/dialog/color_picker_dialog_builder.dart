...
class ColorPickerDialogBuilder {
  ...
  ColorPickerDialogBuilder(this._context, this._currentColor,
      {this.onSelected,
      this.title,
        ...
        builder: (BuildContext context) {
          return PointerInterceptor(
            child: AlertDialog(
                  ...
                  return Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Center(
                          child: Wrap(
                            children: AppColor.listColorsPicker
                                .map(
                                    (color) => _itemColorWidget(context, color))
                                .toList(),
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: ColorCodeField(
                          ...
                          onColorChanged: (Color color) {
                            if (AppColor.listColorsPicker.any(
                                (element) => element.value == color.value)) {
                              _shouldUpdate = true;
              ...
              actions: <Widget>[
                buildButtonWrapText(textActionCancel ?? '',
                    radius: 5,
                    height: 30,
                ...
                buildButtonWrapText(textActionResetDefault ?? '',
                    radius: 5,
                    height: 30,
                    textStyle: const TextStyle(
                        color: Colors.black,
                ...
                buildButtonWrapText(textActionSetColor ?? '',
                    radius: 5,
                    height: 30,
                    textStyle: const TextStyle(
                        color: Colors.white,
      ...
      child: InkWell(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: color,
            border: Border.all(
              color: _currentColor.value == color
                  ? Colors.white
                  : Colors.transparent,
              width: 8,
            ),
