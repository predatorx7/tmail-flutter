...
abstract class ContextMenuActionBuilder<T> {
  ...
  @protected
  OnContextMenuActionClick<T>? onContextMenuActionClick;

  ContextMenuActionBuilder(this.key, this.actionIcon, this.actionName);
  ...
  TextStyle actionTextStyle() {
    return const TextStyle(fontSize: 15, color: AppColor.nameUserColor);
  }
