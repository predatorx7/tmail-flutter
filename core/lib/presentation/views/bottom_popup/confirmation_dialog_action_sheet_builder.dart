...
class ConfirmationDialogActionSheetBuilder {
  ...
  void onCancelAction(
      String cancelText, OnCancelActionClick onCancelActionClick) {
                          ...
                          child: Text(_messageText ?? '',
                              ...
                              style: _styleMessage ??
                                  const TextStyle(
                                      fontSize: 14,
                                      color:
                                          AppColor.colorMessageConfirmDialog)),
                          onPressed: () => {},
                        ),
                      ))
                    ...
                    child: MouseRegion(
                      ...
                      child: CupertinoActionSheetAction(
                        child: Text(_confirmText ?? '',
                            style: _styleConfirmButton ??
                                const TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: 20,
                                    color: AppColor
                                        .colorActionDeleteConfirmDialog)),
              ...
              cancelButton: MouseRegion(
                ...
                child: CupertinoActionSheetAction(
                  child: Text(_cancelText ?? '',
                      style: _styleCancelButton ??
                          const TextStyle(
                              fontWeight: FontWeight.w500,
                              fontSize: 20,
                              color: AppColor.colorActionCancelDialog)),
