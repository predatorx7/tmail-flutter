...
import 'package:tmail_ui_user/features/destination_picker/presentation/destination_picker_view.dart'
    deferred as destination_picker;
...
import 'package:tmail_ui_user/features/rules_filter_creator/presentation/rules_filter_creator_view.dart'
    deferred as rules_filter_creator;
...
import 'package:tmail_ui_user/features/login/presentation/login_view.dart'
    if (dart.library.html) 'package:tmail_ui_user/features/login/presentation/login_view_web.dart'
    deferred as login;
...
import 'package:tmail_ui_user/features/mailbox_dashboard/presentation/mailbox_dashboard_view.dart'
    if (dart.library.html) 'package:tmail_ui_user/features/mailbox_dashboard/presentation/mailbox_dashboard_view_web.dart'
    deferred as mailbox_dashboard;
import 'package:tmail_ui_user/features/manage_account/presentation/manage_account_dashboard_bindings.dart';
import 'package:tmail_ui_user/features/manage_account/presentation/manage_account_dashboard_view.dart'
    deferred as manage_account_dashboard;
...
import 'package:tmail_ui_user/features/search/mailbox/presentation/search_mailbox_view.dart'
    deferred as search_mailbox_view;
...
class AppPages {
  static final pages = [
    ...
    GetPage(
        ...
        page: () =>
            DeferredWidget(session.loadLibrary, () => session.SessionView()),
        binding: SessionPageBindings()),
    GetPage(
        name: AppRoutes.dashboard,
        page: () => DeferredWidget(mailbox_dashboard.loadLibrary,
    ...
    GetPage(
        ...
        opaque: false,
        page: () => DeferredWidget(
            contact_view.loadLibrary, () => contact_view.ContactView()),
    ...
    if (PlatformInfo.isMobile) ...[
      ...
      GetPage(
          ...
          opaque: false,
          page: () => DeferredWidget(search_mailbox_view.loadLibrary,
