...
class EmailReceiveManager {
  BehaviorSubject<EmailAddress?> _pendingEmailAddressInfo =
      BehaviorSubject.seeded(null);
  BehaviorSubject<EmailAddress?> get pendingEmailAddressInfo =>
      _pendingEmailAddressInfo;

  BehaviorSubject<EmailContent?> _pendingEmailContentInfo =
      BehaviorSubject.seeded(null);
  BehaviorSubject<EmailContent?> get pendingEmailContentInfo =>
      _pendingEmailContentInfo;

  BehaviorSubject<List<SharedMediaFile>> _pendingFileInfo =
      BehaviorSubject.seeded(List.empty(growable: true));
  BehaviorSubject<List<SharedMediaFile>> get pendingFileInfo =>
      _pendingFileInfo;
