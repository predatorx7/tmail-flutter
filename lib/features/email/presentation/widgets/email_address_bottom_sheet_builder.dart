...
class EmailAddressBottomSheetBuilder {
  ...
  OnQuickCreatingRuleEmailBottomSheetAction?
      _creatingRuleEmailBottomSheetAction;

  EmailAddressBottomSheetBuilder(
      this._context, this._imagePaths, this._emailAddress);

  void addOnCloseContextMenuAction(
      OnCloseBottomSheetAction onCloseBottomSheetAction) {
    _onCloseBottomSheetAction = onCloseBottomSheetAction;
  }

  void addOnCopyEmailAddressAction(
      OnCopyEmailAddressBottomSheetAction onCopyEmailAddressAction) {
    _onCopyEmailAddressAction = onCopyEmailAddressAction;
  }

  void addOnComposeEmailAction(
      OnComposeEmailBottomSheetAction onComposeEmailAction) {
    _onComposeEmailAction = onComposeEmailAction;
  }

  void addOnQuickCreatingRuleEmailBottomSheetAction(
      OnQuickCreatingRuleEmailBottomSheetAction
          creatingRuleEmailBottomSheetAction) {
                  ...
                  children: [
                      ...
                      child: InkWell(
                        ...
                        onLongPress: () {
                          AppUtils.copyEmailAddressToClipboard(
                              _context, _emailAddress.emailAddress);
                        },
                        borderRadius:
                    ...
                    Material(
                        ...
                        child: TextButton(
                            ...
                            onPressed: () => _onCopyEmailAddressAction
                                ?.call(_emailAddress))),
                        ...
                        child: SizedBox(
                          ...
                          child: TextButton(
                              style: ButtonStyle(
                                  ...
                                  backgroundColor:
                                      MaterialStateProperty.resolveWith<Color>(
                                          (Set<MaterialState> states) => AppColor
                                              .colorItemEmailSelectedDesktop),
                                  shape: MaterialStateProperty.all(RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(8),
                                      side: const BorderSide(width: 0, color: AppColor.colorItemEmailSelectedDesktop)))),
                              child: Text(AppLocalizations.of(_context).quickCreatingRule, style: const TextStyle(fontSize: 17, color: AppColor.colorTextButton, fontWeight: FontWeight.w500)),
                    ...
                    Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: TextButton(
                              ...
                              child: Text(AppLocalizations.of(_context).compose_email, style: const TextStyle(fontSize: 17, color: Colors.white, fontWeight: FontWeight.w500)),
