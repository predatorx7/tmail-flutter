...
class AppBarMailWidgetBuilder extends StatelessWidget {
  ...
  Widget _buildListOptionButton(BuildContext context) {
    return Row(children: [
      ...
      buildIconWeb(
          icon: SvgPicture.asset(_imagePaths.icMoveEmail,
          ...
          onTap: () => onEmailActionClick?.call(
              _presentationEmail, EmailActionType.moveToMailbox)),
      buildIconWeb(
      ...
      buildIconWeb(
          icon: SvgPicture.asset(_imagePaths.icDeleteComposer,
          ...
          onTap: () {
            if (mailboxContain?.isTrash == false) {
              onEmailActionClick?.call(
                  _presentationEmail, EmailActionType.moveToTrash);
            } else {
              onEmailActionClick?.call(
                  _presentationEmail, EmailActionType.deletePermanently);
            }
          }),
      buildIconWebHasPosition(context,
