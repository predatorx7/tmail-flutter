...
class EventDescriptionDetailWidget extends StatelessWidget {
  ...
  const EventDescriptionDetailWidget({super.key, required this.description});
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        borderRadius: BorderRadius.all(
            Radius.circular(EventDescriptionDetailWidgetStyles.borderRadius)),
      ),
      width: double.infinity,
      padding: const EdgeInsetsDirectional.all(
          EventDescriptionDetailWidgetStyles.contentPadding),
      child: Stack(
        children: [
          Text(description,
          ...
          PositionedDirectional(
              top: 0, end: 0, child: SvgPicture.asset(imagePath.icFormatQuote))
        ],
      ),
    );
  }
