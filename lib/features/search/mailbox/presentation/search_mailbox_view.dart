...
class SearchMailboxView extends GetWidget<SearchMailboxController>
  ...
  const SearchMailboxView({Key? key, this.backgroundColor}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(children: [
        Container(
            ...
            padding: SearchMailboxUtils.getPaddingAppBar(
  ...
  Widget _buildSearchInputForm(BuildContext context) {
    return Row(children: [
      buildIconWeb(
          minSize: SearchMailboxUtils.getIconSize(
              context, controller.responsiveUtils),
          iconPadding: EdgeInsets.zero,
          splashRadius: SearchMailboxUtils.getIconSplashRadius(
              context, controller.responsiveUtils),
          icon: SvgPicture.asset(controller.imagePaths.icBack,
      ...
      Expanded(
          child: Container(
              ...
              child: Row(children: [
                Padding(
                  padding: SearchMailboxUtils.getPaddingInputSearchIcon(
                      context, controller.responsiveUtils),
                  child: buildIconWeb(
                      minSize: 40,
                      iconPadding: EdgeInsets.zero,
                      icon: SvgPicture.asset(controller.imagePaths.icSearchBar,
                          colorFilter: AppColor.colorTextButton.asFilter(),
                          fit: BoxFit.fill),
  ...
  Widget _buildMailboxListView(BuildContext context) {
    return Obx(() {
      return ListView.builder(
          padding: SearchMailboxUtils.getPaddingListViewMailboxSearched(
              context, controller.responsiveUtils),
          ...
          itemBuilder: (context, index) {
            return LayoutBuilder(builder: (context, constraints) {
              ...
              return MailboxSearchedItemBuilder(controller.imagePaths,
                  controller.responsiveUtils, mailboxCurrent,
                  maxWidth: constraints.maxWidth,
                  onDragEmailToMailboxAccepted: controller.dashboardController
                      .dragSelectedMultipleEmailToMailboxAction,
                  onClickOpenMailboxAction: (mailbox) =>
                      controller.openMailboxAction(context, mailbox),
                  onClickOpenMenuMailboxAction: (position, mailbox) =>
                      _openMailboxMenuAction(context, mailbox,
                          position: position),
                  onLongPressMailboxAction: (mailbox) =>
                      _openMailboxMenuAction(context, mailbox),
                  listPopupMenuItemAction:
                      _listPopupMenuItemAction(context, mailboxCurrent));
            });
          });
    });
  }

  List<FocusedMenuItem> _listPopupMenuItemAction(
              ...
              child: Row(children: [
                SvgPicture.asset(
                    contextMenuItem.action
                        .getContextMenuIcon(controller.imagePaths),
                    width: 24,
                    height: 24,
                    fit: BoxFit.fill,
                    colorFilter: contextMenuItem.action
                        .getColorContextMenuIcon()
                        .asFilter()),
                ...
                Expanded(
                    child: Text(
                        ...
                        style: TextStyle(
                            ...
                            fontSize: 16,
                            color: contextMenuItem.action
                                .getColorContextMenuTitle()))),
              ]),
            ),
          ),
        ));
  ...
  void _openMailboxMenuAction(BuildContext context, PresentationMailbox mailbox,
    ...
    if (controller.responsiveUtils.isScreenWithShortestSide(context) ||
      ...
      controller.openContextMenuAction(
          ...
          contextMenuMailboxActionTiles(
              context, controller.imagePaths, mailbox, contextMenuActions,
