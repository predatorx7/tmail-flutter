...
class AppBarSelectionMode extends StatelessWidget {
  ...
  final Function(EmailActionType actionType, List<PresentationEmail> emails)?
      onHandleEmailAction;
    ...
    return Row(children: [
      ...
      Expanded(
          child: Text(
              AppLocalizations.of(context)
                  .count_email_selected(listEmail.length),
      ...
      if (canSpamAndMove) ...[
        buildIconWeb(
            ...
            onTap: () => onHandleEmailAction?.call(
                EmailActionType.moveToMailbox, listEmail)),
        const SizedBox(width: 5),
        buildIconWeb(
            minSize: 25,
            iconSize: 25,
            ...
            splashRadius: 15,
            icon: SvgPicture.asset(
                isAllSpam ? _imagePaths.icNotSpam : _imagePaths.icSpam,
                fit: BoxFit.fill),
            tooltip: isAllSpam
            ...
            onTap: () => isAllSpam
                ...
                : onHandleEmailAction?.call(EmailActionType.moveToSpam,
                    listEmail.listEmailCanSpam(mapMailbox))),
        const SizedBox(width: 5),
      ],
      if (isAllBelongToTheSameMailbox) ...[
        buildIconWeb(
            ...
            onTap: () => canDeletePermanently
                ? onHandleEmailAction?.call(
                    EmailActionType.deletePermanently, listEmail)
                : onHandleEmailAction?.call(
                    EmailActionType.moveToTrash, listEmail)),
