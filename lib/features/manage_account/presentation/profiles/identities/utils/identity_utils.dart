...
class IdentityUtils {
  List<Identity>? getSmallestOrderedIdentity(List<Identity>? identities) {
    ...
    final smallestIdentity = identities.fold<Identity>(initialIdentity,
        (previousIdentity, nextIdentity) {
      if (previousIdentity.sortOrder == null &&
          nextIdentity.sortOrder == null) {
    ...
    return identities
        .where((element) => element.sortOrder == smallestIdentity.sortOrder)
        .toList();
  }
