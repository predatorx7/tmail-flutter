        ...
        child: Scaffold(
          ...
          body: SafeArea(
              ...
              child: Column(children: [
                if (!_responsiveUtils.isWebDesktop(context))
                  Container(
                      ...
                      child: Row(children: [
                        ...
                        Obx(() {
                          if (controller
                                  .dashBoardController.appInformation.value !=
                              null) {
                            return Padding(
                ...
                Expanded(
                    child: Container(
                  color: _responsiveUtils.isWebDesktop(context)
                        ...
                        Obx(() {
                          if (controller.listAccountMenuItem.isNotEmpty) {
                            return ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount:
                                    controller.listAccountMenuItem.length,
                              ...
                              child: InkWell(
                                  onTap: () {
                                    controller.dashBoardController.logout(
                                        ...
                                        controller.dashBoardController.accountId
                                            .value);
                                  },
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(children: [
                                      SvgPicture.asset(_imagePaths.icSignOut,
                                          fit: BoxFit.fill),
