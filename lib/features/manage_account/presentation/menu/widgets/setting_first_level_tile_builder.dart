...
class SettingFirstLevelTileBuilder extends StatelessWidget {
  SettingFirstLevelTileBuilder(this.title, this.settingIcon, this.clickAction,
                            ...
                            Padding(
                                padding: EdgeInsets.only(
                                  right: AppUtils.isDirectionRTL(context)
                                      ? SettingsUtils.getHorizontalPadding(
                        ...
                        subtitle != null
                            ? Padding(
                                padding: EdgeInsets.only(
                                    left: AppUtils.isDirectionRTL(context)
                                        ? 12
                                        : _getSubtitleLeftPadding(context),
                                    right: AppUtils.isDirectionRTL(context)
                                        ? _getSubtitleLeftPadding(context)
                                        : 12,
                                    top: 12),
  ...
  Widget _buildSettingIcon(BuildContext context) {
    return SvgPicture.asset(settingIcon,
        height: 24, width: 24, fit: BoxFit.fill);
  }

  double _getSubtitleLeftPadding(BuildContext context) {
    return SettingsUtils.getHorizontalPadding(context, _responsiveUtils) +
        12 +
        24;
  }
}
