    ...
    return SingleChildScrollView(
      child: Column(children: [
        Obx(() => UserInformationWidget(
            ...
            padding:
                SettingsUtils.getPaddingInFirstLevel(context, _responsiveUtils),
            titlePadding: const EdgeInsetsDirectional.only(start: 16))),
        Divider(
            color: AppColor.colorDividerComposer,
            height: 1,
            indent:
                SettingsUtils.getHorizontalPadding(context, _responsiveUtils),
            endIndent:
                SettingsUtils.getHorizontalPadding(context, _responsiveUtils)),
          ...
          if (controller.manageAccountDashboardController
            ...
            return Column(children: [
              SettingFirstLevelTileBuilder(
                  ...
                  subtitle:
                      AppLocalizations.of(context).emailRuleSettingExplanation,
