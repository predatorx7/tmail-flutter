      ...
      return KeyboardRichText(
          ...
          keyBroadToolbar: RichTextKeyboardToolBar(
            ...
            titleQuickStyleBottomSheet:
                AppLocalizations.of(context).quickStyles,
                        ...
                        child: _responsiveUtils.isPortraitMobile(context)
                            ? Column(children: [
                                BorderButtonField<DateTime>(
                                    ...
                                    value: controller
                                        .vacationPresentation.value.startDate,
                                    mouseCursor: SystemMouseCursors.text,
                                    backgroundColor: AppColor
                                        .colorBackgroundVacationSettingField,
                                    isEmpty:
                                        !controller.isVacationDeactivated &&
                                            controller.vacationPresentation
                                                .value.startDateIsNull,
                                    hintText:
                                        AppLocalizations.of(context).startDate,
                                    tapActionCallback: (value) =>
                                        controller.selectDate(
                                            context, DateType.start, value)),
                                const SizedBox(height: 18),
                                BorderButtonField<TimeOfDay>(
                                    label:
                                        AppLocalizations.of(context).startTime,
                                    value: controller
                                        .vacationPresentation.value.startTime,
                                    mouseCursor: SystemMouseCursors.text,
                                    backgroundColor: AppColor
                                        .colorBackgroundVacationSettingField,
                                    isEmpty:
                            ...
                            : Row(children: [
                                Expanded(
                                    child: BorderButtonField<DateTime>(
                                        label: AppLocalizations.of(context)
                                            .startDate,
                                        value: controller.vacationPresentation
                                            .value.startDate,
                                        mouseCursor: SystemMouseCursors.text,
                                        backgroundColor: AppColor
                                            .colorBackgroundVacationSettingField,
                                        ...
                                        tapActionCallback: (value) =>
                                            controller.selectDate(context,
                                                DateType.start, value))),
                                const SizedBox(width: 24),
                                Expanded(
                                    child: BorderButtonField<TimeOfDay>(
                                        label: AppLocalizations.of(context)
                                            .startTime,
                                        value: controller.vacationPresentation
                                            .value.startTime,
                ...
                Obx(() => AbsorbPointer(
                    ...
                    child: Opacity(
                      ...
                      child: Row(children: [
                        Obx(() => InkWell(
                            onTap: () {
                              final value = !controller.vacationPresentation
                                  .value.vacationStopEnabled;
                              controller.updateVacationPresentation(
                                  vacationStopEnabled: value);
                            },
                            child: SvgPicture.asset(
                                controller.vacationPresentation.value
                                        .vacationStopEnabled
                                    ? _imagePaths.icSwitchOn
                                    : _imagePaths.icSwitchOff,
                                fit: BoxFit.fill,
                      ...
                      child: _responsiveUtils.isPortraitMobile(context)
                          ? Column(children: [
                              BorderButtonField<DateTime>(
                                  ...
                                  value: controller
                                      .vacationPresentation.value.endDate,
                                  mouseCursor: SystemMouseCursors.text,
                                  backgroundColor: AppColor
                                      .colorBackgroundVacationSettingField,
                                  ...
                                  tapActionCallback: (value) =>
                                      controller.selectDate(
                                          context, DateType.end, value)),
                              const SizedBox(height: 18),
                              BorderButtonField<TimeOfDay>(
                                  label: AppLocalizations.of(context).endTime,
                                  value: controller
                                      .vacationPresentation.value.endTime,
                                  mouseCursor: SystemMouseCursors.text,
                                  backgroundColor: AppColor
                                      .colorBackgroundVacationSettingField,
                                  isEmpty: controller.canChangeEndDate &&
                                      controller.vacationPresentation.value
                                          .endTimeIsNull,
                                  hintText:
                                      AppLocalizations.of(context).noEndTime,
                                  tapActionCallback: (value) =>
                                      controller.selectTime(
                                          context, DateType.end, value)),
                            ])
  ...
  Widget _buildListButtonAction(BuildContext context) {
    if (_responsiveUtils.isWebDesktop(context)) {
      return Align(
        ...
        child: buildTextButton(AppLocalizations.of(context).saveChanges,
      ...
      if (_responsiveUtils.isPortraitMobile(context)) {
        ...
        return Row(children: [
          ...
          buildTextButton(AppLocalizations.of(context).cancel,
              ...
              onTap: () => controller.backToUniversalSettings(context)),
          const SizedBox(width: 12),
          buildTextButton(AppLocalizations.of(context).saveChanges,
              textStyle: const TextStyle(
                  color: Colors.white,
                  fontWeight: FontWeight.normal,
                  fontSize: 16),
          ...
          Center(
              child: PointerInterceptor(
                  child: buildToolbarRichTextForWeb(
                      context, controller.richTextControllerForWeb,
