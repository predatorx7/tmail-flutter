  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (!spamReportController.enableSpamReport ||
          spamReportController.notShowSpamReportBanner) {
      ...
      return Container(
        ...
        padding:
            const EdgeInsetsDirectional.all(SpamReportBannerStyles.padding),
        decoration: ShapeDecoration(
          ...
          shape: const RoundedRectangleBorder(
            ...
            borderRadius: BorderRadius.all(
                Radius.circular(SpamReportBannerStyles.borderRadius)),
          ),
        ),
        child: Column(
              ...
              children: [
                Expanded(
                  child: SpamReportBannerButtonWidget(
                      ...
                      labelColor:
                          SpamReportBannerButtonStyles.positiveButtonTextColor,
                ...
                Expanded(
                  child: SpamReportBannerButtonWidget(
                      ...
                      labelColor:
                          SpamReportBannerButtonStyles.negativeButtonTextColor,
                      onTap: () => spamReportController
                          .dismissSpamReportAction(context)),
                ),
              ],
            ),
          ],
