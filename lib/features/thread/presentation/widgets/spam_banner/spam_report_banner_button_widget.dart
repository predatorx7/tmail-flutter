    ...
    return Material(
      ...
      child: InkWell(
        ...
        borderRadius: const BorderRadius.all(
            Radius.circular(SpamReportBannerButtonStyles.borderRadius)),
        child: Container(
          width: wrapContent ? null : double.infinity,
          padding: const EdgeInsetsDirectional.all(
              SpamReportBannerButtonStyles.padding),
              ...
              : Row(
                  ...
                  children: [
                    if (iconLeftAlignment)
                      Padding(
                        padding: const EdgeInsetsDirectional.only(
                            end: SpamReportBannerButtonStyles.paddingIcon),
                    ...
                    Text(label,
                        ...
                        style: TextStyle(
                            fontSize:
                                SpamReportBannerButtonStyles.labelTextSize,
                            color: labelColor,
                            fontWeight: FontWeight.w400)),
                    if (!iconLeftAlignment)
                      Padding(
                        padding: const EdgeInsetsDirectional.only(
                            start: SpamReportBannerButtonStyles.paddingIcon),
                        child: SvgPicture.asset(
                          icon!,
                          width: SpamReportBannerButtonStyles.iconSize,
                          height: SpamReportBannerButtonStyles.iconSize,
