...
class EmptyEmailsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
        ...
        children: [
          ...
          if (onCreateFiltersActionCallback != null)
            TMailButtonWidget.fromText(
              ...
              backgroundColor:
                  EmptyEmailsWidgetStyles.createFilterButtonBackgroundColor,
              borderRadius:
                  EmptyEmailsWidgetStyles.createFilterButtonBorderRadius,
              width: responsiveUtils.isPortraitMobile(context)
                  ? double.infinity
                  : null,
              textAlign: TextAlign.center,
              textStyle: const TextStyle(
                  ...
                  fontWeight:
                      EmptyEmailsWidgetStyles.createFilterButtonFontWeight,
    ...
    return Container(
        constraints:
            const BoxConstraints(maxWidth: EmptyEmailsWidgetStyles.maxWidth),
        alignment: AlignmentDirectional.center,
        child: responsiveUtils.isScreenWithShortestSide(context)
            ? SingleChildScrollView(child: childWidget)
            : CustomScrollView(
                slivers: [SliverFillRemaining(child: childWidget)]));
  }
