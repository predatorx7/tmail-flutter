...
class EmailContextMenuActionBuilder
    extends ContextMenuActionBuilder<List<PresentationEmail>> {
  final List<PresentationEmail> _listEmail;

  EmailContextMenuActionBuilder(
      Key key, SvgPicture actionIcon, String actionName, this._listEmail)
  ...
  ListTile build() {
    return ListTile(
        key: key,
        leading: Padding(
            padding: const EdgeInsets.only(left: 12), child: actionIcon),
