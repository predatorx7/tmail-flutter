...
typedef OnPressEmailSelectionActionClick = void Function(
    EmailActionType, List<PresentationEmail>);
          ...
          child: Row(children: [
            if (_currentMailbox?.isDrafts == false)
              Expanded(
                child: TMailButtonWidget(
                  ...
                  icon: _listSelectionEmail.isAllEmailRead
                  ...
                  textStyle: const TextStyle(
                      fontSize: 12, color: AppColor.colorTextButton),
            ...
            Expanded(
              child: TMailButtonWidget(
                ...
                icon: _listSelectionEmail.isAllEmailStarred
            ...
            if (_currentMailbox?.isDrafts == false)
              Expanded(
                child: TMailButtonWidget(
                  ...
                  icon: _currentMailbox?.isSpam == true
