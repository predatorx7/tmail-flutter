...
typedef OnFilterEmailAction = void Function(
    FilterMessageOption, RelativeRect? position);
...
typedef OnEmailSelectionAction = void Function(
    EmailActionType actionType, List<PresentationEmail>);
...
class AppBarThreadWidgetBuilder extends StatelessWidget {
  ...
  Widget _buildBodyAppBarForWeb(BuildContext context) {
    return Row(children: [
      ...
      Expanded(
          child: Text(_currentMailbox?.getDisplayName(context) ?? '',
              maxLines: 1,
    ...
    return Row(children: [
      ...
      Expanded(
          child: Text(
              AppLocalizations.of(context)
                  .count_email_selected(_listSelectionEmail.length),
              style: const TextStyle(
                  fontSize: 17,
      ...
      if (_currentMailbox?.isDrafts == false) ...[
        buildIconWeb(
            ...
            onTap: () => onEmailSelectionAction?.call(
                EmailActionType.moveToMailbox, _listSelectionEmail)),
        const SizedBox(width: 5),
        buildIconWeb(
            minSize: 25,
            iconSize: 25,
            ...
            onTap: () => _currentMailbox?.isSpam == true
                ? onEmailSelectionAction?.call(
                    EmailActionType.unSpam, _listSelectionEmail)
                : onEmailSelectionAction?.call(
                    EmailActionType.moveToSpam, _listSelectionEmail)),
        const SizedBox(width: 5),
      ],
      buildIconWeb(
          minSize: 25,
          ...
          onTap: () => canDeletePermanently
              ? onEmailSelectionAction?.call(
                  EmailActionType.deletePermanently, _listSelectionEmail)
              : onEmailSelectionAction?.call(
                  EmailActionType.moveToTrash, _listSelectionEmail)),
      const SizedBox(width: 10),
    ]);
  }

  bool get canDeletePermanently {
    return _currentMailbox?.isTrash == true ||
        _currentMailbox?.isDrafts == true;
  }
              ...
              children: [
                ...
                Transform(
                    transform: Matrix4.translationValues(
                        _getXTranslationValues(context), -8.0, 0.0),
                    child: Text(_filterMessageOption.getTitle(context),
                        style: const TextStyle(
                            fontSize: 11, color: AppColor.colorContentEmail)))
              ]),
        )
      else
    ...
    return Material(
        ...
        child: TextButton(
          ...
          child: Text(
            ...
            style:
                const TextStyle(fontSize: 17, color: AppColor.colorTextButton),
          ),
        ));
  }
    ...
    return Material(
        ...
        child: InkWell(
            ...
            child: Container(
              ...
              child: SvgPicture.asset(_imagePaths.icFilter,
  ...
  Widget _buildCountItemSelected() {
    return Padding(
        ...
        child: Text('${_listSelectionEmail.length}',
            maxLines: 1,
            overflow: CommonTextStyle.defaultTextOverFlow,
            softWrap: CommonTextStyle.defaultSoftWrap,
            style: const TextStyle(
          ...
          child: Container(
            ...
            child: Row(
                ...
                children: [
                  Container(
                      constraints:
                          BoxConstraints(maxWidth: constraints.maxWidth - 220),
                      child: Text(
