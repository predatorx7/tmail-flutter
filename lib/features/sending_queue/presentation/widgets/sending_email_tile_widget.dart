...
typedef OnSelectSendingEmailItemAction = void Function(
    SendingEmailActionType, SendingEmail);
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      return Material(
        ...
        child: InkWell(
          onTap: () =>
              onTapAction?.call(SendingEmailActionType.edit, sendingEmail),
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding:
                    SendingQueueUtils.getPaddingItemListViewByResponsiveSize(
                    ...
                    children: [
                      if (selectMode == SelectMode.ACTIVE)
                        GestureDetector(
                          ...
                          onTap: () =>
                              onSelectLeadingAction?.call(sendingEmail),
                        )
                      else
                        SvgPicture.asset(
                          sendingEmail
                                  ...
                                  1
                              ? sendingEmail.sendingState
                                  .getAvatarPersonal(imagePaths)
                              : sendingEmail.sendingState
                                  .getAvatarGroup(imagePaths),
                          fit: BoxFit.fill,
                          width: 60,
                          height: 60,
                        ),
                      ...
                      Expanded(
                          child: Column(
                            ...
                            Row(children: [
                                  ...
                                  child: TextOverflowBuilder(
                                      AppLocalizations.of(context)
                                          .titleRecipientSendingEmail(
                                              sendingEmail.presentationEmail
                                                  .recipientsName()),
                                      style: TextStyle(
                                          fontSize: 15,
                                          color: sendingEmail.sendingState
                                              .getTitleSendingEmailItemColor(),
                                          fontWeight: FontWeight.w600))),
                              if (sendingEmail.email.attachments != null &&
                                  sendingEmail.email.attachments!.isNotEmpty)
                                Padding(
                              ...
                              if (!ResponsiveUtils.isMatchedMobileWidth(
                                  constraints.maxWidth))
                                Container(
                            ...
                            TextOverflowBuilder(
                                ...
                                style: TextStyle(
                                    fontSize: 13,
                                    color: sendingEmail.sendingState
                                        .getSubTitleSendingEmailItemColor(),
                                    fontWeight: FontWeight.normal)),
                            if (ResponsiveUtils.isMatchedMobileWidth(
                                constraints.maxWidth))
                              Padding(
              ...
              Padding(
                padding:
                    SendingQueueUtils.getPaddingDividerListViewByResponsiveSize(
                        constraints.maxWidth),
                child:
