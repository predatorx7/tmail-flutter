...
class SendingQueueRepositoryImpl extends SendingQueueRepository {
  ...
  Future<List<SendingEmail>> getAllSendingEmails(
    ...
    return _emailHiveCacheDataSourceImpl.getAllSendingEmails(
        accountId, userName);
  }
  ...
  Future<void> deleteSendingEmail(
    ...
    return _emailHiveCacheDataSourceImpl.deleteSendingEmail(
  ...
  Future<SendingEmail> updateSendingEmail(
    ...
    return _emailHiveCacheDataSourceImpl.updateSendingEmail(
  ...
  Future<SendingEmail> storeSendingEmail(
    ...
    return _emailHiveCacheDataSourceImpl.storeSendingEmail(
        accountId, userName, sendingEmail);
  }
  ...
  Future<List<SendingEmail>> updateMultipleSendingEmail(AccountId accountId,
    ...
    return _emailHiveCacheDataSourceImpl.updateMultipleSendingEmail(
        accountId, userName, newSendingEmails);
  }

  @override
  Future<void> deleteMultipleSendingEmail(
      AccountId accountId, UserName userName, List<String> sendingIds) {
    return _emailHiveCacheDataSourceImpl.deleteMultipleSendingEmail(
  ...
  Future<SendingEmail> getStoredSendingEmail(
      AccountId accountId, UserName userName, String sendingId) {
    return _emailHiveCacheDataSourceImpl.getStoredSendingEmail(
        accountId, userName, sendingId);
  }
}
