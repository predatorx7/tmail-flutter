...
class SearchMailboxInteractor {
  Stream<Either<Failure, Success>> execute(
      List<PresentationMailbox> mailboxes, SearchQuery searchQuery) async* {
    try {
  ...
  bool _matchMailboxByQuery(
      PresentationMailbox mailbox, SearchQuery searchQuery) {
    if (mailbox.displayName == null) {
      ...
      return mailbox.displayName!
          ...
          searchQuery.value
              .toLowerCase()
              .contains(mailbox.displayName!.toLowerCase());
    }
  }
}
