...
class MailboxView extends BaseMailboxView {
            ...
            child: Drawer(
              ...
              body: Column(
                  ...
                  children: [
                      ...
                      child: Column(children: [
                        ...
                        Obx(() {
                          if (controller.isSelectionEnabled() &&
                              controller
                                  .listActionOfMailboxSelected.isNotEmpty) {
                            return SafeArea(
                                right: false,
                                top: false,
                                child: BottomBarSelectionMailboxWidget(
                                    ...
                                    onMailboxActionsClick:
                                        (actions, listMailboxSelected) {
                                  return controller.pressMailboxSelectionAction(
                                      context, actions, listMailboxSelected);
                                }));
                          } else {
                    ...
                    Obx(() {
                      final appInformation = controller
                          .mailboxDashBoardController.appInformation.value;
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(
          padding: EdgeInsets.only(
              top: responsiveUtils.isMobile(context) ? 10 : 30, bottom: 8),
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Obx(() => _buildEditMailboxButton(
                context, controller.isSelectionEnabled()))
          ])),
  ...
  Widget _buildEditMailboxButton(
      BuildContext context, bool isSelectionEnabled) {
    return Padding(
        ...
        child: Column(children: [
          ...
          Obx(() {
            if (controller.defaultMailboxIsNotEmpty) {
              return _buildMailboxCategory(context, MailboxCategories.exchange,
          ...
          Container(
            ...
            child: Row(children: [
              Expanded(
                child: Text(AppLocalizations.of(context).mailBoxes,
                    style: const TextStyle(
                        fontSize: 20,
                        color: Colors.black,
                        fontWeight: FontWeight.bold)),
              ...
              Row(children: [
                buildIconWeb(
                    ...
                    icon: SvgPicture.asset(imagePaths.icSearchBar,
                ...
                buildIconWeb(
                    ...
                    iconPadding: EdgeInsets.zero,
                    splashRadius: 15,
                    icon: SvgPicture.asset(imagePaths.icAddNewFolder,
                        colorFilter: AppColor.colorTextButton.asFilter(),
                        fit: BoxFit.fill),
  ...
  Widget _buildHeaderMailboxCategory(
      BuildContext context, MailboxCategories categories) {
    return Padding(
        padding: EdgeInsetsDirectional.only(
            start: 4, end: responsiveUtils.isLandscapeMobile(context) ? 8 : 28),
        child: Row(children: [
          buildIconWeb(
              minSize: 40,
              iconSize: 20,
  ...
  Widget _buildBodyMailboxCategory(BuildContext context,
    ...
    return Container(
        margin: EdgeInsetsDirectional.only(
            start: responsiveUtils.isLandscapeMobile(context) ? 0 : 8, end: 16),
            ...
            return TreeViewChild(context,
                    ...
                    parent: Obx(() => MailboxItemWidget(
                          ...
                          onLongPressMailboxNodeAction: (mailboxNode) =>
                              openMailboxMenuActionOnMobile(context, imagePaths,
                                  mailboxNode.item, controller),
                          ...
                          onSelectMailboxFolderClick: (mailboxNode) =>
            ...
            return Obx(() => MailboxItemWidget(
                ...
                onLongPressMailboxNodeAction: (mailboxNode) =>
                    openMailboxMenuActionOnMobile(
                        context, imagePaths, mailboxNode.item, controller),
                onOpenMailboxFolderClick: (mailboxNode) =>
                    controller.openMailbox(context, mailboxNode.item),
                onSelectMailboxFolderClick: (mailboxNode) =>
                    controller.selectMailboxNode(mailboxNode)));
