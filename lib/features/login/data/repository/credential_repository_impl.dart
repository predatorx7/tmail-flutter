...
class CredentialRepositoryImpl extends CredentialRepository {
  ...
  CredentialRepositoryImpl(
      this.sharedPreferences, this._authenticationInfoCacheManager);

  @override
  Future<Uri> getBaseUrl() async {
    return Uri.parse(
        sharedPreferences.getString(LoginConstants.KEY_BASE_URL) ?? '');
  }

  @override
  Future saveBaseUrl(Uri baseUrl) async {
    await sharedPreferences.setString(
        LoginConstants.KEY_BASE_URL, baseUrl.toString());
  }
  ...
  Future<void> storeAuthenticationInfo(
    ...
    return _authenticationInfoCacheManager
        .storeAuthenticationInfo(authenticationInfoCache);
  }
