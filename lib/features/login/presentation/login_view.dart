...
class LoginView extends BaseLoginView {
            ...
            child: SafeArea(
              child: _supportScrollForm(context)
                  ? Stack(children: [
                      ...
                      Obx(() {
                        if (controller.loginFormType.value ==
                                LoginFormType.credentialForm ||
                            controller.loginFormType.value ==
  ...
  Widget _buildUrlInput(BuildContext context) {
    return Padding(
        ...
        child: TypeAheadFormFieldBuilder<RecentLoginUrl>(
          ...
          onSuggestionSelected: (loginUrl) =>
              controller.formatUrl(loginUrl.url),
  ...
  Widget _buildExpandedButton(BuildContext context, Widget child) {
    return Expanded(
        child: Align(alignment: FractionalOffset.bottomCenter, child: child));
  }
