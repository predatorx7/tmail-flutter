...
class LoginView extends BaseLoginView {
      ...
      children: [
        ConstrainedBox(
            constraints: const BoxConstraints(
                minWidth: 200, maxWidth: 720, minHeight: 720),
            child: Column(
              ...
              children: [
                ...
                Obx(() =>
                    buildLoginMessage(context, controller.viewState.value)),
                Obx(() {
        ...
        Positioned.fill(
            ...
            child: Align(
                ...
                child: SvgPicture.asset(imagePaths.icPowerByLinagora,
                    width: 97, height: 44, fit: BoxFit.fill)))
      ],
    );
  }
          ...
          children: [
            Padding(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(AppLocalizations.of(context).jmapBasedMailSolution,
                        style: const TextStyle(
                            fontSize: 36,
                            color: AppColor.colorNameEmail,
                            fontWeight: FontWeight.w900)),
                    ...
                    Padding(
                        ...
                        child: SloganBuilder(
                            ...
                            paddingText: const EdgeInsets.only(left: 12),
                            text:
                                AppLocalizations.of(context).manageEmailAsATeam,
                            textStyle: const TextStyle(
                                fontSize: 24,
                                fontWeight: FontWeight.w400,
                                color: AppColor.colorNameEmail))),
                    ...
                    Padding(
                        ...
                        child: SvgPicture.asset(imagePaths.icLoginGraphic,
                              ...
                              Padding(
                                  ...
                                  child: Text(
                                      ...
                                      style: const TextStyle(
                                          ...
                                          color: AppColor.colorNameEmail,
                                          fontWeight: FontWeight.w900))),
                              Obx(() => buildLoginMessage(
                                  context, controller.viewState.value)),
                              Obx(() {
                                switch (controller.loginFormType.value) {
                                  case LoginFormType.credentialForm:
                                    return buildInputCredentialForm(context);
  ...
  Widget _buildAppLogo(BuildContext buildContext) {
    return Row(mainAxisSize: MainAxisSize.min, children: [
      SvgPicture.asset(imagePaths.icTMailLogo,
          fit: BoxFit.fill, width: 36, height: 36, alignment: Alignment.center),
      Padding(
        padding: const EdgeInsets.symmetric(horizontal: 10),
        child: Text(AppLocalizations.of(buildContext).app_name,
            style: const TextStyle(
            ...
            style: ButtonStyle(
                ...
                shape: MaterialStateProperty.all(RoundedRectangleBorder(
                    ...
                    side: const BorderSide(
                        width: 0, color: AppColor.primaryColor)))),
  ...
  Widget _buildLoadingProgress(BuildContext context) {
    return Obx(() => controller.viewState.value.fold((failure) {
          switch (controller.loginFormType.value) {
