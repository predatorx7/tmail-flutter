...
typedef OnSelectEmailAddressDropListAction = Function(
...
class IdentityDropListFieldBuilder extends StatelessWidget {
  ...
  const IdentityDropListFieldBuilder(this._imagePaths, this._label,
      this._emailAddressSelected, this._listEmailAddress,
      {super.key, this.onSelectItemDropList});
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      DropdownButtonHideUnderline(
        child: DropdownButton2<EmailAddress>(
          ...
          items: _listEmailAddress
              .map((item) => DropdownMenuItem<EmailAddress>(
                    value: item,
                    child: Text(
                      item.emailAddress,
                      style: const TextStyle(
