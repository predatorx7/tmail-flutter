...
typedef UpdateDownloadTaskStateCallback = DownloadTaskState Function(
    DownloadTaskState currentState);
...
class DownloadController extends GetxController {
  ...
  void updateDownloadTaskByTaskId(
    ...
    if (matchIndex >= 0) {
      listDownloadTaskState[matchIndex] =
  ...
  void deleteDownloadTask(DownloadTaskId taskId) {
    ...
    final matchIndex =
        listDownloadTaskState.indexWhere((task) => task.taskId == taskId);
    if (matchIndex >= 0) {
