...
class SearchInputFormWidget extends StatelessWidget with AppLoaderMixin {
                ...
                buttonActionCallback: (filterAction) {
                  if (filterAction is QuickSearchFilter) {
                    _dashBoardController
                        .addFilterToSuggestionForm(filterAction);
                  }
                },
  ...
  void _invokeSearchEmailAction(BuildContext context, String query) {
    ...
    if (query.isNotEmpty ||
        _searchController.listFilterOnSuggestionForm.isNotEmpty) {
      _searchController.applyFilterSuggestionToSearchFilter(
          _dashBoardController.userProfile.value);
  ...
  void _invokeSelectSuggestionItem(
  ...
  QuickSearchTextFieldConfiguration _createConfiguration(BuildContext context) {
    return QuickSearchTextFieldConfiguration(
        ...
        onSubmitted: (keyword) =>
            _invokeSearchEmailAction(context, keyword.trim()),
        decoration: InputDecoration(
            ...
            hintStyle: const TextStyle(
                color: AppColor.colorHintSearchBar, fontSize: 16.0),
        ...
        leftButton: Padding(
            ...
            child: buildIconWeb(
                ...
                icon:
                    SvgPicture.asset(_imagePaths.icSearchBar, fit: BoxFit.fill),
                onTap: () => _invokeSearchEmailAction(context,
                    _searchController.searchInputController.text.trim()))),
  ...
  Widget buildListButtonForQuickSearchForm(
    ...
    return Obx(() {
      final isFilterSelected =
          filter.isApplied(_searchController.listFilterOnSuggestionForm);
      ...
      return Chip(
        ...
        backgroundColor:
            filter.getBackgroundColor(isFilterSelected: isFilterSelected),
