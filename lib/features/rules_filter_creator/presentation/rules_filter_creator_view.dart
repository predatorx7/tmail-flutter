...
class RuleFilterCreatorView extends GetWidget<RulesFilterCreatorController> {
              ...
              body: GestureDetector(
                ...
                child: Align(
                    ...
                    child: Container(
                        ...
                        height:
                            _responsiveUtils.getSizeScreenHeight(context) * 0.7,
                        child: ClipRRect(
                            borderRadius: const BorderRadius.only(
                                topLeft: Radius.circular(16),
                                topRight: Radius.circular(16)),
                        ...
                        child: Container(
                            decoration: const BoxDecoration(
                                ...
                                borderRadius:
                                    BorderRadius.all(Radius.circular(16))),
                            width:
                                _responsiveUtils.getSizeScreenWidth(context) *
                                    0.6,
                            height:
                                _responsiveUtils.getSizeScreenHeight(context) *
                                    0.7,
                            child: ClipRRect(
                                borderRadius:
                                    const BorderRadius.all(Radius.circular(16)),
                                child:
                                    _buildRulesFilterFormOnDesktop(context))))),
              ))),
    );
  }
    ...
    return Stack(children: [
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(
            ...
            child: Obx(() => Text(controller.actionType.value.getTitle(context),
          ...
          child: Padding(
            ...
            child:
              ...
              Obx(() => RulesFilterInputField(
                    hintText:
                        AppLocalizations.of(context).rulesNameHintTextInput,
              ...
              Container(
                  ...
                  child: Row(
                      ...
                      children: [
                        Expanded(
                            child: Obx(() =>
                                DropDownButtonWidget<rule_condition.Field>(
                                    items: rule_condition.Field.values,
                                    itemSelected: controller
                                        .ruleConditionFieldSelected.value,
                                    dropdownMaxHeight: 250,
                                    onChanged: (newField) => controller
                                        .selectRuleConditionField(newField),
                                    supportSelectionIcon: true))),
                        Container(
                            width: 220,
                            padding: const EdgeInsets.symmetric(horizontal: 12),
                            child: Obx(() =>
                                DropDownButtonWidget<rule_condition.Comparator>(
                                    items: rule_condition.Comparator.values,
                                    itemSelected: controller
                                        .ruleConditionComparatorSelected.value,
                                    onChanged: (newComparator) => controller
                                        .selectRuleConditionComparator(
                                            newComparator),
                                    supportSelectionIcon: true))),
                        Expanded(
                            child: Obx(() => RulesFilterInputField(
                                hintText: AppLocalizations.of(context)
                                    .conditionValueHintTextInput,
                                errorText:
                                    controller.errorRuleConditionValue.value,
                                editingController:
                                    controller.inputConditionValueController,
                                focusNode:
                                    controller.inputRuleConditionFocusNode,
                                onChangeAction: (value) => controller
                                    .updateConditionValue(context, value))))
                      ])),
              const SizedBox(height: 24),
              ...
              Container(
                  ...
                  child: Row(children: [
                    Expanded(
                        child: Obx(() =>
                            DropDownButtonWidget<EmailRuleFilterAction>(
                                items: EmailRuleFilterAction.values,
                                itemSelected: controller
                                    .emailRuleFilterActionSelected.value,
                                onChanged: (newAction) => controller
                                    .selectEmailRuleFilterAction(newAction),
                                supportSelectionIcon: true))),
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 12),
                      child: Text(AppLocalizations.of(context).toMailbox,
                          overflow: CommonTextStyle.defaultTextOverFlow,
                          softWrap: CommonTextStyle.defaultSoftWrap,
                          maxLines: 1,
                          style: const TextStyle(
        ...
        Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            buildTextButton(AppLocalizations.of(context).cancel,
      ...
      Positioned(
          ...
          right: 8,
          child: buildIconWeb(
              icon: SvgPicture.asset(_imagePaths.icCloseMailbox,
                  fit: BoxFit.fill),
    ...
    return Stack(children: [
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
          ...
          child: Row(children: [
            Expanded(
                child: buildTextButton(AppLocalizations.of(context).cancel,
                    textStyle: const TextStyle(
                        fontWeight: FontWeight.w500,
                        fontSize: 17,
                        color: AppColor.colorTextButton),
          ...
          child: Padding(
            ...
            child:
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Obx(() {
                            return RuleFilterButtonField<
                                    rule_condition.Comparator>(
                                value: controller
                                    .ruleConditionComparatorSelected.value,
                                tapActionCallback: (value) {
                                  KeyboardUtils.hideKeyboard(context);
                                  controller.openContextMenuAction(
                                      ...
                                      _bottomSheetRuleConditionComparatorActionTiles(
                                          context,
                                          controller
                                              .ruleConditionComparatorSelected
                                              .value));
                                });
                          }),
                        ),
              ...
              const Padding(
                padding: EdgeInsets.symmetric(vertical: 12),
                child:
                    Divider(color: AppColor.colorDividerRuleFilter, height: 1),
              ),
              Text(AppLocalizations.of(context).actionTitleRulesFilter,
                  overflow: CommonTextStyle.defaultTextOverFlow,
                  softWrap: CommonTextStyle.defaultSoftWrap,
  ...
  List<Widget> _bottomSheetRuleConditionFieldActionTiles(
      BuildContext context, rule_condition.Field? fieldSelected) {
  ...
  Widget _buildRuleConditionFieldWidget(BuildContext context,
      rule_condition.Field field, rule_condition.Field? fieldSelected) {
    return (RuleConditionFieldSheetActionTileBuilder(
            field.getTitle(context), fieldSelected, field,
  ...
  List<Widget> _bottomSheetRuleConditionComparatorActionTiles(
      BuildContext context, rule_condition.Comparator? comparatorSelected) {
    return rule_condition.Comparator.values
        .map((comparator) => _buildRuleConditionComparatorWidget(
            context, comparator, comparatorSelected))
        .toList();
  }
  ...
  Widget _buildRuleConditionComparatorWidget(
    ...
    return (RuleConditionComparatorSheetActionTileBuilder(
            comparator.getTitle(context), comparatorSelected, comparator,
            iconLeftPadding: const EdgeInsets.only(left: 12, right: 16),
            iconRightPadding: const EdgeInsets.only(right: 12),
            actionSelected: SvgPicture.asset(_imagePaths.icFilterSelected,
                width: 20, height: 20, fit: BoxFit.fill))
  ...
  List<Widget> _bottomSheetActionRuleFilterActionTiles(
      BuildContext context, EmailRuleFilterAction? ruleActionSelected) {
  ...
  Widget _buildRuleActionWidget(
    ...
    return (RuleActionSheetActionTileBuilder(
            ruleAction.getTitle(context), ruleActionSelected, ruleAction,
            iconLeftPadding: const EdgeInsets.only(left: 12, right: 16),
            iconRightPadding: const EdgeInsets.only(right: 12),
            actionSelected: SvgPicture.asset(_imagePaths.icFilterSelected,
                width: 20, height: 20, fit: BoxFit.fill))
