...
class ComposerView extends BaseComposerView {
                      ...
                      child: Column(
                        ...
                        ToolbarRichTextWebBuilder(
                          richTextWebController:
                              controller.richTextWebController,
                          padding: ComposerStyle.getRichTextButtonPadding(
                  ...
                  child: Card(
                      ...
                      shape: const RoundedRectangleBorder(
                          borderRadius: BorderRadius.all(
                              Radius.circular(ComposerStyle.radius))),
                      child: Container(
                          ...
                          height: responsiveUtils.getSizeScreenHeight(context) *
                              0.75,
                          child: ClipRRect(
                              borderRadius: const BorderRadius.all(
                                  Radius.circular(ComposerStyle.radius)),
                              child: LayoutBuilder(
                                  builder: (context, constraints) => PointerInterceptor(
                                      child: _buildBodyForDesktop(context, constraints))))))),
            if (controller.screenDisplayMode.value ==
                          ...
                          child: ClipRRect(
                              ...
                              child: PointerInterceptor(
                                ...
                                buildIconWeb(
                                    ...
                                    onTap: () => controller
                                        .displayScreenTypeComposerAction(
                                            ScreenDisplayMode.fullScreen)),
                                buildIconWeb(
                                    icon: SvgPicture.asset(
                                        imagePaths.icChevronUp,
                                        fit: BoxFit.fill),
                      ...
                      child: Card(
                          ...
                          child: Container(
                              ...
                              child: ClipRRect(
                                  borderRadius: const BorderRadius.all(
                                      Radius.circular(ComposerStyle.radius)),
                                  child: LayoutBuilder(builder: (context, constraints) => PointerInterceptor(child: _buildBodyForDesktop(context, constraints))))))))
          ]);
        }),
        tablet: Scaffold(
            backgroundColor: Colors.black38,
            body: Center(
                child: Card(
                    elevation: 20,
                    margin: ComposerStyle.getMarginForTabletWeb(
                        context, responsiveUtils),
                    shape: const RoundedRectangleBorder(
                        borderRadius: BorderRadius.all(
                            Radius.circular(ComposerStyle.radius))),
                    child: Container(
                        decoration: const BoxDecoration(
                            ...
                            borderRadius: BorderRadius.all(
                                Radius.circular(ComposerStyle.radius))),
                        width: ComposerStyle.getWidthForTabletWeb(
                            context, responsiveUtils),
                        child: ClipRRect(
                            borderRadius: const BorderRadius.all(
                                Radius.circular(ComposerStyle.radius)),
                            child: LayoutBuilder(
                                builder: (context, constraints) => PointerInterceptor(child: _buildBodyForDesktop(context, constraints)))))))));
  }
      ...
      child: Row(children: [
        ...
        if (responsiveUtils.isDesktop(context)) ...[
          Obx(() => buildIconWeb(
              ...
              iconPadding: EdgeInsets.zero,
              icon: SvgPicture.asset(
                  controller.screenDisplayMode.value ==
                          ScreenDisplayMode.fullScreen
          ...
          buildIconWeb(
              ...
              onTap: () => controller
                  .displayScreenTypeComposerAction(ScreenDisplayMode.minimize)),
        ],
        ...
        child: PointerInterceptor(
          child: IntrinsicHeight(
            child: Row(children: [
              Obx(() => buildIconWeb(
                  icon: Icon(
                      controller.hasRequestReadReceipt.value
                          ? Icons.done
                          : null,
                      color: Colors.black))),
              Expanded(
    ...
    return Column(children: [
      ...
      Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
            ...
            child: (AvatarBuilder()
                  ..text(controller.mailboxDashBoardController.userProfile.value
                          ?.getAvatarText() ??
                      '')
                  ..size(56)
      ...
      ToolbarRichTextWebBuilder(
        ...
        padding:
            ComposerStyle.getRichTextButtonPadding(context, responsiveUtils),
      ),
      buildInlineLoadingView(controller),
      Expanded(child: _buildEditorForm(context)),
      buildDivider(),
  ...
  Widget _buildEmailAddressWeb(
      BuildContext context, BoxConstraints constraints) {
    return ConstrainedBox(
        constraints: BoxConstraints(
            maxHeight: ComposerStyle.getMaxHeightEmailAddressWidget(
                context, constraints, responsiveUtils)),
        child: SingleChildScrollView(
        ...
        child: Padding(
            ...
            child: Row(children: [
              buildIconWeb(
                  ...
                  onTap: () =>
                      controller.openFilePickerByType(context, FileType.any)),
              const SizedBox(width: 4),
              Obx(() {
                final opacity = controller.richTextWebController.codeViewEnabled
                    ? 0.5
                    : 1.0;
              ...
              Obx(() {
                return buildIconWeb(
                    minSize: 40,
                    colorSelected:
                        controller.richTextWebController.codeViewEnabled
      ...
      switch (argsComposer.emailActionType) {
        ...
        case EmailActionType.composeFromFileShared:
          return _buildHtmlEditor(
              context, currentTextEditor ?? HtmlExtension.editorStartTags);
        case EmailActionType.editDraft:
        case EmailActionType.editSendingEmail:
        case EmailActionType.composeFromContentShared:
        case EmailActionType.reopenComposerBrowser:
          final emailContentsViewState =
              controller.emailContentsViewState.value;
          ...
          return emailContentsViewState.fold(
            ...
            if (success is GetEmailContentLoading) {
              ...
              return _buildHtmlEditor(
                  context, currentTextEditor ?? contentHtml);
            } else {
              return _buildHtmlEditor(
                  context, currentTextEditor ?? HtmlExtension.editorStartTags);
            }
        ...
        case EmailActionType.forward:
          ...
          return emailContentsViewState.fold((failure) {
            ...
            return _buildHtmlEditor(
                context, currentTextEditor ?? emailContentQuoted);
          }, (success) {
