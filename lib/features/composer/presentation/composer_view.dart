...
class ComposerView extends BaseComposerView {
                    ...
                    keyBroadToolbar: RichTextKeyboardToolBar(
                      ...
                      insertAttachment: controller.isNetworkConnectionAvailable
                          ? () => controller.openPickAttachmentMenu(
                              context, _pickAttachmentsActionTiles(context))
                          : null,
                      ...
                      titleBackgroundBottomSheet:
                          AppLocalizations.of(context).titleBackground,
                      titleForegroundBottomSheet:
                          AppLocalizations.of(context).titleForeground,
                      titleFormatBottomSheet:
                          AppLocalizations.of(context).titleFormat,
                    ...
                    return KeyboardRichText(
                      ...
                      keyBroadToolbar: RichTextKeyboardToolBar(
                        ...
                        insertAttachment: () =>
                            controller.openPickAttachmentMenu(
                                context, _pickAttachmentsActionTiles(context)),
                        insertImage: () => controller.insertImage(
                            context, constraints.maxWidth),
                        richTextController:
                            controller.keyboardRichTextController,
                        titleQuickStyleBottomSheet:
                            AppLocalizations.of(context).titleQuickStyles,
                        titleBackgroundBottomSheet:
                            AppLocalizations.of(context).titleBackground,
                      ...
                      child: Center(
                        ...
                        child: Card(
                            elevation: 20,
                            margin: ComposerStyle.getMarginForTablet(
                            ...
                            child: Container(
                                decoration: const BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.all(
                                        Radius.circular(ComposerStyle.radius))),
                                width: ComposerStyle.getWidthForTablet(
                                    context, responsiveUtils),
                                child: ClipRRect(
                                    ...
                                    child: Column(children: [
                                      ...
                                      buildDivider(),
                                      Expanded(
                                          child: _buildBodyTablet(context)),
                                      buildDivider(),
                                      Padding(
    ...
    return [
      PopupMenuItem(
        ...
        child: Row(children: [
          Obx(() => buildIconWeb(
              icon: Icon(
                  controller.hasRequestReadReceipt.value ? Icons.done : null,
                  color: Colors.black))),
          IgnorePointer(
            child: buildTextIcon(
  ...
  Widget _pickPhotoAndVideoAction(BuildContext context) {
    return (SimpleContextMenuActionBuilder(
            ...
            SvgPicture.asset(imagePaths.icPhotoLibrary,
                width: 24, height: 24, fit: BoxFit.fill),
            AppLocalizations.of(context).photos_and_videos)
          ..onActionClick(
              (_) => controller.openFilePickerByType(context, FileType.media)))
        .build();
  }
  ...
  Widget _browseFileAction(BuildContext context) {
    return (SimpleContextMenuActionBuilder(
            ...
            SvgPicture.asset(imagePaths.icMore,
                width: 24, height: 24, fit: BoxFit.fill),
            AppLocalizations.of(context).browse)
          ..onActionClick(
              (_) => controller.openFilePickerByType(context, FileType.any)))
        .build();
  }
      ...
      switch (argsComposer.emailActionType) {
        ...
        case EmailActionType.reopenComposerBrowser:
          ...
          return emailContentsViewState.fold(
              (failure) => _buildHtmlEditor(context,
                  initialContent: HtmlExtension.editorStartTags), (success) {
      ...
      child: Padding(
        ...
        child: HtmlEditor(
            ...
            onCreated: (editorApi) => controller.initRichTextForMobile(
                context, editorApi, initialContent)),
      ),
    );
  }
}
