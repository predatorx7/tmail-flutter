...
class ComposerStyle {
  ...
  static EdgeInsetsGeometry getFromAddressPadding(
      BuildContext context, ResponsiveUtils responsiveUtils) {
    if (responsiveUtils.isPortraitMobile(context) ||
        responsiveUtils.isLandscapeMobile(context)) {
  ...
  static EdgeInsetsGeometry getToAddressPadding(
      BuildContext context, ResponsiveUtils responsiveUtils) {
  ...
  static EdgeInsetsGeometry getCcBccAddressPadding(
      BuildContext context, ResponsiveUtils responsiveUtils) {
    if (PlatformInfo.isWeb) {
      if (responsiveUtils.isMobile(context)) {
  ...
  static EdgeInsetsGeometry getSubjectPadding(
      BuildContext context, ResponsiveUtils responsiveUtils) {
    if (responsiveUtils.isPortraitMobile(context) ||
        responsiveUtils.isLandscapeMobile(context)) {
      ...
      return const EdgeInsetsDirectional.only(
          start: 8, top: 8, bottom: 8, end: 16);
    }
  }

  static EdgeInsetsGeometry getSubjectWebPadding(
      BuildContext context, ResponsiveUtils responsiveUtils) {
    if (responsiveUtils.isMobile(context)) {
      return const EdgeInsetsDirectional.symmetric(horizontal: 16);
    } else {
  ...
  static EdgeInsetsGeometry getAttachmentPadding(
      BuildContext context, ResponsiveUtils responsiveUtils) {
    if (responsiveUtils.isPortraitMobile(context) ||
        responsiveUtils.isLandscapeMobile(context)) {
      return const EdgeInsetsDirectional.symmetric(horizontal: 16);
  ...
  static EdgeInsetsGeometry getRichTextButtonPadding(
      BuildContext context, ResponsiveUtils responsiveUtils) {
    if (responsiveUtils.isMobile(context)) {
      return const EdgeInsetsDirectional.symmetric(horizontal: 16, vertical: 8);
    } else {
      return const EdgeInsetsDirectional.only(
          start: 88, end: 48, top: 8, bottom: 8);
    }
  }

  static EdgeInsetsGeometry getEditorPadding(
      BuildContext context, ResponsiveUtils responsiveUtils) {
    if (PlatformInfo.isWeb) {
      if (responsiveUtils.isMobile(context)) {
  ...
  static EdgeInsetsGeometry getMarginForTablet(
      BuildContext context, ResponsiveUtils responsiveUtils) {
  ...
  static double getWidthForTablet(
      BuildContext context, ResponsiveUtils responsiveUtils) {
  ...
  static EdgeInsetsGeometry getMarginForTabletWeb(
      BuildContext context, ResponsiveUtils responsiveUtils) {
  ...
  static double getWidthForTabletWeb(
      BuildContext context, ResponsiveUtils responsiveUtils) {
    final currentWidth = responsiveUtils.getSizeScreenWidth(context);
    if (responsiveUtils.isTablet(context)) {
      return currentWidth;
  ...
  static int getMaxItemRowListAttachment(
  ...
  static double getMaxWidthItemListAttachment(
      BuildContext context, BoxConstraints constraints) {
    return constraints.maxWidth /
        getMaxItemRowListAttachment(context, constraints);
  }

  static double getMaxHeightEmailAddressWidget(BuildContext context,
      BoxConstraints constraints, ResponsiveUtils responsiveUtils) {
