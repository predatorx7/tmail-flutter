...
class ToolbarRichTextWebBuilder extends StatelessWidget
              ...
              AbsorbPointer(
                ...
                child: DropDownMenuHeaderStyleWidget(
                    icon: buildWrapIconStyleText(
                        ...
                        tooltip: RichTextStyleType.headerStyle
                    ...
                    onMenuStateChange: (isOpen) {
                      ...
                      richTextWebController.menuHeaderStyleStatus.value =
                          newStatus;
                    },
                    onChanged: (newStyle) =>
                        richTextWebController.applyHeaderStyle(newStyle)),
              ),
              AbsorbPointer(
                absorbing: codeViewEnabled,
                child: Container(
                    ...
                    child: DropDownButtonWidget<FontNameType>(
                        ...
                        itemSelected:
                            richTextWebController.selectedFontName.value,
                        onChanged: (newFont) =>
                        ...
                        onMenuStateChange: (isOpen) {
                          ...
                          final newStatus = isOpen
                              ? DropdownMenuFontStatus.open
                              : DropdownMenuFontStatus.closed;
                          richTextWebController.menuFontStatus.value =
                              newStatus;
                        },
                        heightItem: 40,
                        sizeIconChecked: 16,
                        ...
                        tooltip: RichTextStyleType.fontName
                            .getTooltipButton(context),
                ...
                child: AbsorbPointer(
                  ...
                  child: buildWrapIconStyleText(
                      icon: buildIconWithTooltip(
                          path:
                              RichTextStyleType.textColor.getIcon(_imagePaths),
                          color: richTextWebController.selectedTextColor.value,
                          tooltip: RichTextStyleType.textColor
                              .getTooltipButton(context),
                          opacity: opacity),
                ...
                child: AbsorbPointer(
                  ...
                  child: buildWrapIconStyleText(
                      ...
                      icon: buildIconColorBackgroundText(
                          iconData: RichTextStyleType.textBackgroundColor
                              .getIconData(),
                          colorSelected: richTextWebController
                    ...
                    icon: Wrap(children: [
                      AbsorbPointer(
                        ...
                        child: buildIconStyleText(
                            ...
                            isSelected:
                                richTextWebController.isTextStyleTypeSelected(
                                    RichTextStyleType.bold),
                            tooltip: RichTextStyleType.bold
                                .getTooltipButton(context),
                            opacity: opacity,
                            onTap: () =>
                      ...
                      AbsorbPointer(
                        ...
                        child: buildIconStyleText(
                            ...
                            tooltip: RichTextStyleType.italic
                                .getTooltipButton(context),
                            opacity: opacity,
                            onTap: () =>
                                richTextWebController.applyRichTextStyle(
                      ...
                      AbsorbPointer(
                        absorbing: codeViewEnabled,
                        child: buildIconStyleText(
                            path: RichTextStyleType.underline
                                .getIcon(_imagePaths),
                            isSelected:
                                richTextWebController.isTextStyleTypeSelected(
                                    RichTextStyleType.underline),
                            tooltip: RichTextStyleType.underline
                                .getTooltipButton(context),
                            opacity: opacity,
                            onTap: () =>
                                richTextWebController.applyRichTextStyle(
                      ...
                      AbsorbPointer(
                        absorbing: codeViewEnabled,
                        child: buildIconStyleText(
                            path: RichTextStyleType.strikeThrough
                                .getIcon(_imagePaths),
                            isSelected:
                                richTextWebController.isTextStyleTypeSelected(
                                    RichTextStyleType.strikeThrough),
                            tooltip: RichTextStyleType.strikeThrough
                                .getTooltipButton(context),
                            opacity: opacity,
                            onTap: () =>
                                richTextWebController.applyRichTextStyle(
                  ...
                  child: PopupMenuOverlayWidget(
                    ...
                    listButtonAction: ParagraphType.values
                        .map((paragraph) => paragraph.buildButtonWidget(
                            context,
                            _imagePaths,
                            (paragraph) => richTextWebController
                                .applyParagraphType(paragraph)))
                        .toList(),
                    iconButton: buildWrapIconStyleText(
                        ...
                        spacing: 3,
                        isSelected:
                            richTextWebController.focusMenuParagraph.value,
                        icon: buildIconWithTooltip(
                  ...
                  child: PopupMenuOverlayWidget(
                    ...
                    listButtonAction: OrderListType.values
                        .map((orderType) => orderType.buildButtonWidget(
                            context,
                            _imagePaths,
                            (orderType) => richTextWebController
                                .applyOrderListType(orderType)))
                        .toList(),
                    iconButton: buildWrapIconStyleText(
                        padding: const EdgeInsets.symmetric(
                            vertical: 5, horizontal: 5),
                        spacing: 3,
                        isSelected:
                            richTextWebController.focusMenuOrderList.value,
                        icon: buildIconWithTooltip(
                            path: richTextWebController.selectedOrderList.value
                                .getIcon(_imagePaths),
                            color: AppColor.colorDefaultRichTextButton,
                            opacity: opacity,
                            tooltip: RichTextStyleType.orderList
                                .getTooltipButton(context))),
                  ),
                ),
              )
