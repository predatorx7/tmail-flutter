...
class ComposerRepositoryImpl extends ComposerRepository {
  ...
  ComposerRepositoryImpl(
      this._attachmentUploadDataSource, this._composerDataSource);

  @override
  Future<UploadAttachment> uploadAttachment(FileInfo fileInfo, Uri uploadUri,
      {CancelToken? cancelToken}) {
    return _attachmentUploadDataSource.uploadAttachment(fileInfo, uploadUri,
        cancelToken: cancelToken);
  }

  @override
  Future<String?> downloadImageAsBase64(
      String url, String cid, FileInfo fileInfo,
      {double? maxWidth, bool? compress}) {
    return _composerDataSource.downloadImageAsBase64(url, cid, fileInfo,
        maxWidth: maxWidth, compress: compress);
  }
}
