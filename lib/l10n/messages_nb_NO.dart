...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m4(fileName) => "Laster ned ${fileName} …";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "add_recipients":
            MessageLookupByLibrary.simpleMessage("Legg til mottagere"),
        ...
        "photos_and_videos":
            MessageLookupByLibrary.simpleMessage("Bilder og videoer"),
        "preparing_to_export":
            MessageLookupByLibrary.simpleMessage("Forbereder eksportering …"),
