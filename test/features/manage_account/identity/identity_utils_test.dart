...
void main() {
  ...
  group('get smallest sortOrder identity test', () {
    test(
        'getSmallestOrderedIdentity return identity with sortOrder equals to 1',
        () {
      final sortOrders = [1, 99, 999, 100, 201];
      final listIdentities1 =
          sortOrders.map((e) => Identity(sortOrder: UnsignedInt(e))).toList();
    ...
    test(
        'getSmallestOrderedIdentity return list identities with sortOrder equals to 1',
        () {
    ...
    test(
        'getSmallestOrderedIdentity return identity with sortOrder equals to 2',
        () {
    ...
    test(
        'getSmallestOrderedIdentity return list identities with sortOrder equals to null',
        () {
    ...
    test(
        'getSmallestOrderedIdentity return list identities with sortOrder equals to 0',
        () {
    ...
    test(
        'getSmallestOrderedIdentity return identity with sortOrder equals to 0',
        () {
  ...
  group('test sort list of all identities', () {
    test(
        'should return a list of identities with increasing sortOrder of identities',
        () {
      ...
      expect(
          listIdentities1,
          [0, 1, 9, 12, 95, 98, 99]
              .map((e) => Identity(sortOrder: UnsignedInt(e)))
              .toList());
    });

    test(
        'should return a list of identities with increasing sortOrder of identities, null identity will be put at the end of list',
        () {
      ...
      expect(
          listIdentities1,
          [1, 9, 12, 95, 98, 99, null]
              .map(
                  (e) => Identity(sortOrder: e != null ? UnsignedInt(e) : null))
              .toList());
    });

    test(
        'return a list of identities with all null value at the end of list and 999 is the first identities in list',
        () {
